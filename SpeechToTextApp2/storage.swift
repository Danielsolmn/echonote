...
// 🧾 This represents a single transcription item
...
struct Secrets {
    static let openAIKey = "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" // your key
}
...
struct SummaryEntry: Codable {
    ...
    let summaryType: String  // e.g. "bullet", "action", "tldr", "tweet"
    let timestamp: String
}



// 🗃 Functions to save and load transcription history
class TranscriptionStorage {
    // Key to use in UserDefaults
    private static let key = "transcriptions"
    
    // Save array of Transcription to UserDefaults
    ...
    // Load array of Transcription from UserDefaults
    ...
    // Add a new transcription to the top of the list
